...
class Draw:
    ...
    def drawTetromino(self, tetromino):
        ...
        pygame.draw.polygon(self.screen, "WHITE", self.getScaledCoords(tetromino.vertexCoords), self.pieceOutline)
    ...
    def drawControls(self):
        ...
        shiftText = gameFont.render("SHIFT:         Swap Piece", True, self.fontColour)
